  ...
  return (
    ...
    >
      ...
      <LegalSection title="7. Your choices and rights">
        <p>From Profile, you can review or change preferences, remove saved schools, download a JSON copy of your account data, and permanently delete your account. You can clear guest information through your browser settings.</p>
