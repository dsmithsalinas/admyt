...
interface SupportResult {
  ...
  email_preferences?: { deadline_reminders_enabled: boolean; plan_reminders_enabled: boolean; getting_started_enabled: boolean; weekly_digest_enabled: boolean; timezone: string; updated_at: string } | null
