...
for (const route of ['/', '/chat', '/search', '/profile', '/plan', '/data-and-privacy', '/terms', '/privacy', '/admin', '/admin/data-quality', '/admin/support', '/admin/incidents', '/admin/audit', '/email-operations']) {
